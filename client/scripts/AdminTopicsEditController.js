(function() {
  ...
  function AdminTopicsEditController(currentAuth, $http, $routeParams, Data) {
    ...
    vm.update = function() {
      ...
      console.log('selected contact 1:', vm.selectedContact1);
      console.log('selected contact 2:', vm.selectedContact2);
      console.log('selected contact 3:', vm.selectedContact3);
    };
  }
})();
